...
plt.bar(x_axis, count_positive_maybe, color='r')
plt.bar(x_axis, count_negative_maybe, bottom = count_positive_maybe, color='b')
plt.bar(x_axis, count_not_sure_maybe, bottom = count_positive_maybe + count_negative_maybe, color='y')
