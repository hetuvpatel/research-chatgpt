...
ax = df2.plot.bar(rot=0, color={"Science": "green", "Engineering": "red", "Arts":"blue", "Medical": "yellow", "Finance": "purple", "Business": "pink", "Politics": "orange"})
ax.set_xlabel('Highest Level of Study')
ax.set_ylabel('Average Reliability of ChatGPT Answers')
ax.set_title('Reliability of ChatGPT Answers Across Various Levels of Education',fontweight = 'bold')
