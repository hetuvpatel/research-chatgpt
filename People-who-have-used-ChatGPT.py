...
plt.bar(x_axis, count_18_23_yes, color='r')
plt.bar(x_axis, count_24_30_yes, bottom = count_18_23_yes, color='b')
plt.bar(x_axis, count_30_yes, bottom = count_18_23_yes + count_24_30_yes, color='y')
plt.xlabel("Gender")
