...
plt.bar(x_axis_new, count_18_23_no, color='c')
plt.bar(x_axis_new, count_24_30_no, bottom = count_18_23_no, color='m')
plt.bar(x_axis_new, count_30_no, bottom = count_18_23_no + count_24_30_no, color='b')
plt.xlabel("Gender")
