...
plt.bar(x_axis, count_positive_yes, color='r')
plt.bar(x_axis, count_negative_yes, bottom = count_positive_yes, color='b')
plt.bar(x_axis, count_not_sure_yes, bottom = count_positive_yes + count_negative_yes, color='y')
plt.xlabel("Plagarism")
plt.ylabel("Number of People")
plt.legend(["Positive Impact", "Negative Impact", "Not Sure"])
plt.title("Universities should adapt ChatGPT")
plt.show()
